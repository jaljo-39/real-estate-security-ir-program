### Real Estate Security & Incident Response Program

## Case Study: Georgia Peach Title & Law, LLC
...
- Risk assessment methodology and risk register development
- PCI DSS and SOX IT General Controls awareness
- Business Email Compromise (BEC) risk mitigation
- Incident response planning and documentation
- Linux least privilege and access control practices
- Security reporting and remediation planning

This project was developed to showcase hands-on cybersecurity capabilities aligned with Associate Cybersecurity Analyst and GRC Analyst roles.
